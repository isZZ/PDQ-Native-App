...
export default class Message extends React.Component {
  ...
  renderName() {
    ...
    if(!this.isSameUser(this.props.currentMessage, this.props.previousMessage) && this.props.currentMessage.user._id !== this.props.user
._id){
       return <Username {...this.props.currentMessage.user} />;
    }
  }
